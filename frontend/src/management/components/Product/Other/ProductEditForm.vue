...
import SingleAttributeValueGenerator from "@/management/components/Product/AttributeGenerator/Single/SingleAttributeValueGenerator.vue";
import CombinedAttributeValueGenerator from "@/management/components/Product/AttributeGenerator/Combined/CombinedAttributeValueGenerator.vue";
