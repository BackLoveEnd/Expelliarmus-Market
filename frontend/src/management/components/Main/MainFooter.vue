      ...
      >
        ...
        <div v-show="isContentVisible" class="content">
          ...
          >
            ...
            >
              <router-link to="/management">Home</router-link>
            </li>
            <li
              class="hover:underline underline-offset-4 decoration-2 mb-2 md:mb-0"
            >
            ...
            <li
              class="hover:underline underline-offset-4 decoration-2 mb-2 md:mb-0"
            >
              <router-link to="/management/warehouse">Warehouse</router-link>
            </li>
            <li @mouseenter="handleMenuEnter" @mouseleave="handleMenuLeave">
...
const contentLinks = ref([
  { url: "/management/content/slider", name: "Slider" },
  { url: "/management/content/new-arrivals", name: "New Arrivals" },
]);

const productLinks = ref([
  { url: "/management/products", name: "All Products" },
  { url: "/management/products/create", name: "Add Product" },
  { url: "/management/categories-and-brands", name: "Categories & Brands" },
]);
