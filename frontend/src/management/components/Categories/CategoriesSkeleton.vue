...
<template>
  ...
  <div class="flex justify-between flex-wrap">
    <div
        role="status"
        class="max-w-[240px] border border-gray-300 rounded-lg p-4"
        v-for="index in cardNumber"
        :key="index"
    >
      <div
          class="animate-pulse w-full bg-gray-300 h-24 rounded-lg mb-5 flex justify-center items-center"
      >
        <svg
