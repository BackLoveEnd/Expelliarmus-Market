<template>
  <div class="w-272 h-auto flex flex-col gap-4 group">
    <div class="relative overflow-hidden">
      ...
      <div
          class="absolute top-3 left-3 w-14 h-6 bg-[#db4444] text-center rounded-md"
      >
    ...
    <div class="flex flex-col space-y-2">
      <p class="font-medium">{{ props.discountedProduct?.product?.title }}</p>
      <div class="flex gap-3">
        <p class="font-medium text-[#db4444]">{{ '$' + props.discountedProduct?.discountPrice }}</p>
