<template>
  <footer class="mt-auto bg-black text-[#FAFAFA]">
    <div class="container mx-auto">
      <div
          class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 my-20"
      >
        <div class="flex flex-col flex-shrink-0">
          <div>
            <div class="space-y-6">
              <router-link v-once class="text-2xl font-bold logo" to="/"
              >Expelliarmus Shop
              </router-link>
              <p v-once class="text-xl font-medium">Subscribe</p>
            </div>
            <div class="mt-10 max-w-64">
              <label for="offer-email" class="text-base"
              >Get 10% off your first order</label
              >
              <div
                  class="flex items-center justify-between border border-gray-100 mt-4"
              >
                <input
                    type="text"
                    id="offer-email"
                ...
                >
                  <svg
                      class="fill-current text-[#FAFAFA] hover:text-gray-500"
                      width="16"
                      height="17"
                      viewBox="0 0 16 17"
                      fill="none"
        ...
        <div class="flex flex-col mt-1 max-w-40">
          ...
          <ul class="list-none space-y-4 text-sm">
            <li>
              <router-link @click.prevent="scrollToTop" to="/account?tab=0"
              >My account
              </router-link>
            </li>
            <li>
              <router-link @click.prevent="scrollToTop" to="/log-in"
              >Login / Register
              </router-link>
            </li>
            <li><a href="#">Cart</a></li>
            <li>
              <router-link @click.prevent="scrollToTop" to="/wishlist"
              >Wishlist
              </router-link>
            </li>
            <li>
              <router-link @click.prevent="scrollToTop" to="/"
              >Shop
              </router-link>
            </li>
          </ul>
